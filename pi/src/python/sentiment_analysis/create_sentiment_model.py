...
lexicon_root = 'sentiment_analysis/lexicons/combined/'
train_data_file = 'sentiment_analysis/data/tweets-b-train'
test_data_file = 'sentiment_analysis/data/dev-tweets-b'
saved_model_dir = 'sentiment_analysis/saved_model/'
